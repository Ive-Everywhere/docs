---
title: Eluu docs — build AI colleagues for your business
description: Build AI colleagues that own functions like sales, support, and ops, working across Gmail, Slack, Sheets, Salesforce, and the rest of your stack.
mode: frame
---
