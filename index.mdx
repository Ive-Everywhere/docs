---
title: Eluu docs
description: Eluu documentation for business operators. Build AI colleagues that own functions like sales, support, and research across every tool you connect.
mode: frame
---
...
<div className="flex w-full flex-col gap-8 max-w-5xl mx-auto px-4 md:px-8 lg:px-12 py-10 lg:gap-14 lg:py-16">
  ...
  <CardGroup cols={2}>
    <Card title="Start with the concepts" icon="lightbulb" href="/concepts/colleagues">
      Colleagues, sessions, Hard Drive, jobs, views, integrations. Read this first.
    </Card>
