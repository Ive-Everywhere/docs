---
title: Eluu docs
description: Eluu documentation — build AI colleagues that own sales, support, ops, and research functions across every tool you connect, with Slack and views.
mode: frame
---
