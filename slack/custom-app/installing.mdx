...
description: Install your custom Slack app in your workspace, authorise the permissions, and map your Eluu colleague to channels so the team can mention them by name.
icon: download
---
