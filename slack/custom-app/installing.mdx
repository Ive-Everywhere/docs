...
description: Install your custom Slack app in your workspace, authorise the permissions, and map the colleague to channels so teammates can mention them directly.
icon: download
---
