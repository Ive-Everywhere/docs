...
description: Install your custom Slack app to your workspace, authorise its permissions, then map the colleague to channels and start mentioning them by name.
icon: download
---
