...
description: Install your custom Eluu Slack app in your workspace, authorise it, then map the colleague to channels and start mentioning them under their own @name.
icon: download
---
