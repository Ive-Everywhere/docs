---
title: Install the custom Slack app in your workspace
description: Install your custom Slack app to the workspace, authorise permissions, map the colleague to channels, and rotate signing secrets when needed.
icon: download
---
