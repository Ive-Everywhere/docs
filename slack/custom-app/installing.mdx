...
description: Install your custom Slack app in your workspace, authorise its permissions, then map the colleague to channels so it answers under its own name.
icon: download
---
