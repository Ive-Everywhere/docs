...
description: Install your new Slack app into your workspace, approve the permissions, and start mentioning the colleague in channels and threads right away.
icon: download
---
