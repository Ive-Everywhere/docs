...
description: Install your new custom Slack app in your workspace, approve the requested scopes, and start mentioning the colleague by its branded name in any channel.
icon: download
---
