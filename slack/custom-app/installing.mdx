...
description: Install your custom Slack app to your workspace, authorise permissions, map the Eluu colleague to channels, and rotate the signing secret when needed.
icon: download
---
