...
description: Install your custom Slack app in your workspace, authorise the permissions it requests, and start mentioning your Eluu colleague in channels.
icon: download
---
