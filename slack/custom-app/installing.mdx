...
description: Step 3 of the custom Slack app setup. Install your new Slack app in your workspace, authorize permissions, and start mentioning your colleague in channels.
icon: download
---
