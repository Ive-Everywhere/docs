...
description: Install your custom Slack app to your workspace, authorise the requested permissions, and map the colleague to channels so teammates can mention them.
icon: download
---
