...
description: Install your custom Slack app in your workspace, authorise the permissions, then map the colleague to channels and mention them to start chatting.
icon: download
---
