...
description: Install your custom Slack app to the workspace, authorise its permissions, map the colleague to channels, and rotate the signing secret when needed.
icon: download
---
