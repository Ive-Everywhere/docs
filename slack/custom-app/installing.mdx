...
description: Install your custom Slack app, authorise its permissions in your workspace, and map the Eluu colleague to the channels where it should respond.
icon: download
---
