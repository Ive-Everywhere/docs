...
description: Install your custom Slack app into your workspace, invite the colleague to the channels you want them in, and start mentioning them like any teammate.
icon: download
---
