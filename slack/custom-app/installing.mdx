...
description: Install your custom Slack app in your workspace, authorise its permissions, and start mentioning your colleague directly in channels and DMs.
icon: download
---
