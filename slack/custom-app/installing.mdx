...
description: Install your custom Slack app in your workspace, authorise its permissions, then map your Eluu colleague to channels and mention them by name.
icon: download
---
