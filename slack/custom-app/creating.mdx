...
description: Create a branded Slack app for an Eluu colleague using the provided manifest — paste the JSON, fill in three identity fields, and Slack builds the app.
icon: file-plus
---
