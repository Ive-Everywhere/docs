...
description: Create a branded Slack app from a pre-built manifest so a colleague gets its own @mention name, identity, and bot user in your Slack workspace.
icon: file-plus
---
