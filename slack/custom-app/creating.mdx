...
description: Create a custom Slack app for your colleague using Eluu's pre-built manifest, giving them their own @name and identity in your Slack workspace.
icon: file-plus
---
