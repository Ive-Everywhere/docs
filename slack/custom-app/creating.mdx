...
description: Create a custom Slack app for your colleague using the provided manifest, giving them their own branded handle like @Sofia or @Max in your workspace.
icon: file-plus
---
