...
description: Step 1 of the custom Slack app setup. Use the provided manifest at api.slack.com/apps to create a Slack app for your colleague — only three fields to fill.
icon: file-plus
---
