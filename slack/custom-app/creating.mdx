...
description: Create a custom Slack app for an Eluu colleague using the provided manifest, so they show up under their own name and icon in your Slack workspace.
icon: file-plus
---
...
<Steps>
  ...
  <Step title="Click 'From a manifest'">
    Click **From a manifest**. This pre-fills almost everything for you.
  </Step>
  ...
  <Step title="Paste the manifest">
    ...
    ```json
    {
        ...
        "features": {
            ...
            "assistant_view": {
                "assistant_description": "Colleague created on Eluu",
                "suggested_prompts": []
            }
        },
        "oauth_config": {
...
A Slack app, named after your colleague, that lives at `api.slack.com/apps/<id>`. It's not installed in your workspace yet — that's step 3. First, you connect it to the colleague in Eluu.
