...
description: Create a branded Slack app for your Eluu colleague using the provided manifest. Set the name, description, and bot handle, then move on to connecting it.
icon: file-plus
---
