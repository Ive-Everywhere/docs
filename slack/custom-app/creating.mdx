...
description: Create a custom Slack app so a colleague gets their own handle like `@Sofia`. Paste the provided manifest, fill three fields, and submit it to Slack.
icon: file-plus
---
