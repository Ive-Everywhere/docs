...
description: Take the four credentials from your new Slack app — bot token, signing secret, and others — and paste them into the matching colleague in Eluu to connect them.
icon: link
---
...
<Steps>
  ...
  <Step title="Open Slack settings in Eluu">
    In Eluu, click the Slack icon in the bottom-left of the sidebar. Choose **Custom Slack mention**.
  </Step>
