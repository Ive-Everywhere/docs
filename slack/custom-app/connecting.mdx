...
description: Paste your Slack app's credentials — signing secret, app token, bot token — into Eluu so the colleague you picked handles its messages and mentions.
icon: link
---
