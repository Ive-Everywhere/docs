...
description: Connect a custom Slack app to an Eluu colleague by copying the credentials from Slack and pasting them into the matching colleague in your team.
icon: link
---
