...
description: Paste your custom Slack app's credentials into Eluu and assign a colleague so messages to that branded app route to the right teammate's session.
icon: link
---
