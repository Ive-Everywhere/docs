...
description: Paste your Slack app's App ID, Client ID, Client Secret, and Signing Secret into Eluu, then assign the colleague that should handle its messages.
icon: link
---
