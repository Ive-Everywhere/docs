...
description: Paste the Slack app's App ID, Client ID, Client Secret, and Signing Secret into Eluu, pick a colleague, and link the app to that colleague's identity.
icon: link
---
