...
description: Paste your Slack app's App ID, Client ID, Client Secret, and Signing Secret into Eluu, then pick the colleague that should handle its messages.
icon: link
---
