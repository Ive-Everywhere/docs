...
description: Copy the bot token, signing secret, and app token from your new Slack app and paste them into the matching colleague in Eluu to wire them together.
icon: link
---
