...
description: Paste your Slack app's App ID, Client ID, Client Secret, and Signing Secret into Eluu so the matching colleague handles its mentions and messages.
icon: link
---
