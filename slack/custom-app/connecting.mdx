...
description: Paste your custom Slack app's App ID, Client ID, Client Secret, and Signing Secret into Eluu and map the app to the colleague that handles its messages.
icon: link
---

You've created the Slack app. Now hand its credentials to Eluu so the right colleague handles its messages.
