...
description: Paste the App ID, Client ID, Client Secret, and Signing Secret from your new Slack app into Eluu so the right colleague handles incoming messages.
icon: link
---
