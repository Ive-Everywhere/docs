...
description: Wire your custom Slack app to a colleague in Eluu by pasting the App ID, Client ID, Client Secret, and Signing Secret from Slack's app settings.
icon: link
---
