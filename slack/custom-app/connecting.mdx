...
description: Paste the App ID, Client ID, Client Secret, and Signing Secret from your custom Slack app into Eluu so the right colleague handles its messages.
icon: link
---
