...
description: Step 2 of the custom Slack app setup. Copy the signing secret, app token, and bot token from Slack and paste them into the matching Eluu colleague.
icon: link
---
