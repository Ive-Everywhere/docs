...
description: Take the bot token and signing secret from your new Slack app and paste them into the matching Eluu colleague so the two are wired together.
icon: link
---
