...
description: Take credentials from your custom Slack app and paste them into the matching Eluu colleague — signing secret, bot token, app ID, and webhook URL.
icon: link
---
