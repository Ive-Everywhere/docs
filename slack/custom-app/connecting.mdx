...
description: Paste your Slack app's App ID, Client ID, Client Secret, and Signing Secret into Eluu, then pick which colleague answers when the app is mentioned.
icon: link
---
