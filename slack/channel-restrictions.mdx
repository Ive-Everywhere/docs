...
Private channels work the same as public ones — pick them in the picker, add them to the list. A workspace member needs to invite the colleague into a private channel before they can respond there, regardless of allow-list state.
