...
description: Control which Slack channels each Eluu colleague can answer in. Pin them to the right channels, block specific ones, and keep replies on topic.
icon: lock
---
