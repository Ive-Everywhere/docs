...
description: Control where an Eluu colleague answers in Slack. Allow everywhere, pin them to specific channels, or block sensitive ones from the connection settings.
icon: lock
---
