...
description: Control which Slack channels each Eluu colleague can answer in. Pin them to specific channels, block sensitive ones, or allow everywhere by default.
icon: lock
---
