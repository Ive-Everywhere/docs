...
description: Pin colleagues to specific Slack channels with allow lists, or keep them out of sensitive channels with block lists, controlling exactly where they reply.
icon: lock
---
