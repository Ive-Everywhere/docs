...
description: Limit where an Eluu colleague replies in Slack using allow lists, block lists, or allow-everywhere mode to keep them out of sensitive channels.
icon: lock
---
