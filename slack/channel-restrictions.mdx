...
description: Restrict where a colleague replies in Slack using Allow everywhere, Allow list, or Block list modes to pin them to specific channels or off-limits ones.
icon: lock
---
