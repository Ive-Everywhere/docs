...
description: Control which Slack channels each Eluu colleague can reply in. Pin colleagues to specific channels, block others, and keep responses where they belong.
icon: lock
---
