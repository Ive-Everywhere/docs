...
Private channels work the same as public ones — pick them in the picker, add them to the list. The colleague needs to be invited to the channel by a workspace member before they can respond there, regardless of allow-list state.
