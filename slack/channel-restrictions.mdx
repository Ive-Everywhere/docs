...
description: Control which Slack channels an Eluu colleague can answer in with allow lists, block lists, or open access across public and private channels.
icon: lock
---
