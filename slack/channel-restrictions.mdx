...
description: Control which Slack channels an Eluu colleague can respond in. Pin them to specific channels, block others, or let them answer anywhere they're added.
icon: lock
---
