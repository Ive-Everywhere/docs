...
description: Control which Slack channels each Eluu colleague can answer in. Pin a colleague to specific channels, or block ones where they should stay quiet.
icon: lock
---
