...
Private channels work the same as public ones — pick them in the picker, add them to the list. A workspace member must invite the colleague to the channel before they can respond there, regardless of allow-list state.
