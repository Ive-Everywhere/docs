...
Private channels work the same as public ones — pick them in the picker, add them to the list. A workspace member needs to invite the colleague to the channel before it can respond there — the allow list won't override that.
