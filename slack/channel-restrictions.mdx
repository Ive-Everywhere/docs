...
description: Pin a colleague to specific Slack channels with allow lists, or keep it out of sensitive ones with block lists, so it only replies where you want.
icon: lock
---
