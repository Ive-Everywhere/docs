...
description: Control where a colleague responds in Slack. Use allow lists to pin them to specific channels or block lists to keep them out of sensitive ones.
icon: lock
---
