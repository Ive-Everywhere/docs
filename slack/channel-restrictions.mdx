...
description: Control which Slack channels a colleague can answer in using allow lists or block lists — pin them to specific channels or keep them out of sensitive ones.
icon: lock
---
