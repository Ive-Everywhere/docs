...
description: Pick allow everywhere, an allow list, or a block list to control which Slack channels an Eluu colleague is permitted to respond in across your workspace.
icon: lock
---
