...
description: Control which Slack channels an Eluu colleague answers in. Allow everywhere, pin to an allow list, or block specific channels with sensitive content.
icon: lock
---
