...
description: Control which channels a colleague can answer in. Pin them to the right channels, or block specific ones.
icon: lock
---

By default, your colleague can answer in any channel you've added them to. That's usually too much. Channel restrictions let you say exactly where a colleague should and shouldn't respond.
