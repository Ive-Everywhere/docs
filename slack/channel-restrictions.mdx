...
description: Control which Slack channels a colleague answers in using allow lists, block lists, or open access — including support for private channels and DMs.
icon: lock
---
