...
description: Control which Slack channels an Eluu colleague can answer in. Pin them to specific channels, block noisy ones, or let them respond anywhere they're added.
icon: lock
---
