...
description: Run a colleague's skills in chat — by describing the task or with a slash command — to get the same steps, same checks, and same output shape every time.
icon: blocks
---
