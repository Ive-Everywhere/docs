...
description: Run pre-packaged skills inside a session for repeatable tasks with consistent quality — describe the task or trigger the skill with a slash command.
icon: blocks
---
