...
description: Run packaged Eluu skills inside a session via slash commands or natural prompts to get consistent multi-step output for repeatable team workflows.
icon: blocks
---
