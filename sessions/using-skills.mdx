...
description: Run pre-packaged workflows on a colleague for repeatable tasks — same steps, same checks, same output every time. Trigger by chat or slash command.
icon: blocks
---
