...
description: Run a colleague's skills in a session — by describing the task or via slash commands — for repeatable workflows with consistent output every time.
icon: blocks
---
