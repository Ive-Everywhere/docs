...
description: Run packaged skills inside a session so a colleague follows the same steps, checks, and output shape every time — turning one-off chats into reliable workflows.
icon: blocks
---
