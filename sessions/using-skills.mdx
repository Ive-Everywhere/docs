...
description: Run pre-packaged skills in a session to execute repeatable workflows — pipeline reviews, customer briefs, weekly digests — the same shape every time.
icon: blocks
---
