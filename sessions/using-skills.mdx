...
description: Trigger a colleague's skills by describing the task or typing a slash command — packaged workflows that run the same steps and output shape every time.
icon: blocks
---
