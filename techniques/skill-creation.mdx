...
description: Build skills that hold up after the hundredth run — start with the happy path, capture preferences explicitly, and handle missing data and edge cases.
icon: wand-sparkles
---
