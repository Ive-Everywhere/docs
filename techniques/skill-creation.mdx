---
title: Skill creation that holds up in production
description: Build Eluu skills that hold up in production — start with the happy path, capture preferences, handle missing data, and keep instructions simple.
icon: wand-sparkles
---

A skill that works the first time isn't always a skill that works the hundredth time. The difference is how you handle the things that aren't in the happy path: odd inputs, missing data, your team's preferences, the corner cases that only show up after you've used a skill twenty times.
