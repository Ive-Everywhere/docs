...
description: How to build skills that hold up in production. Edge cases, preferences, the patterns that make a skill reliable.
icon: wand-sparkles
---

A skill that works the first time isn't always a skill that works the hundredth time. The difference is how you handle the things that aren't in the typical case — odd inputs, missing data, your team's specific preferences. The corner cases show up only when you've used a skill twenty times.

This page is about making skills that hold up.

## Start with the typical case
