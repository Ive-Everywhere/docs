...
description: Build skills that hold up in production — start with the happy path, layer in edge cases, capture preferences, and handle missing data instead of guessing.
icon: wand-sparkles
---
