...
description: Build colleague skills that survive real use — start with the happy path, layer edge cases, capture preferences, and handle missing data gracefully.
icon: wand-sparkles
---
