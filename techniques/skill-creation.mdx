...
A skill that works the first time isn't always a skill that works the hundredth time. The difference is how you handle what isn't in the happy path. Odd inputs, missing data, your team's preferences, the corner cases that only show up after you've used a skill twenty times.
