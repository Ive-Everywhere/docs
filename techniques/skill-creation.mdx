...
description: Build skills that hold up in production — start with the happy path, add edge cases from real runs, capture preferences, and handle missing data.
icon: wand-sparkles
---
