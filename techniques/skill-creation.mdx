...
A skill that works the first time isn't always a skill that works the hundredth time. The difference is how you handle the things outside the happy path — odd inputs, missing data, your team's preferences. The corner cases only show up after you've used a skill twenty times.
