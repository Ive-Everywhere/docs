...
description: Build skills that hold up in production — handle edge cases, capture team preferences, and use the patterns that make a colleague's workflow reliable.
icon: wand-sparkles
---
