...
description: Build colleague skills that hold up in production — start with the happy path, capture preferences, handle missing data, and fix drift over time.
icon: wand-sparkles
---
