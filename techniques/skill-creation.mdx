...
description: Build skills that hold up in production — start with the happy path, layer in edge cases, capture preferences, and recover gracefully from missing data.
icon: wand-sparkles
---
