...
description: Build skills that hold up in production. Start with the happy path, capture preferences, handle missing data, and verify outputs before they ship.
icon: wand-sparkles
---
