...
A skill that works the first time isn't always a skill that works the hundredth time. The difference is how you handle what's outside the happy path — odd inputs, missing data, your team's preferences, the corner cases that show up only after you've used a skill twenty times.
