...
description: How to build skills for Eluu colleagues that hold up in production. Cover edge cases, capture preferences, and apply the patterns that make a skill reliable.
icon: wand-sparkles
---
