...
description: Build reliable colleague skills that hold up in production — start with the happy path, layer in edge cases, capture preferences, and harden over time.
icon: wand-sparkles
---
