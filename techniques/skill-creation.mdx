...
description: Build colleague skills that hold up in production — start with the happy path, capture preferences, handle missing data, and verify before shipping.
icon: wand-sparkles
---
