...
Shared connections work for everyone on the team — but each user authenticates with their own account. Alice and Bob both use the same shared connection, but Alice never sees Bob's emails. See [Personal vs Shared](/integrations/team-vs-personal).
