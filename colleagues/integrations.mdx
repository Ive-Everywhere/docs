...
Shared connections work for everyone on the team — but each user authenticates with their own account. Alice and Bob each use the same shared connection for Gmail, but Alice never sees Bob's emails. See [Personal vs Shared](/integrations/team-vs-personal).
