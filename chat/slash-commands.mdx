...
The slash and the command name are sent as part of the message — your colleague sees `/research <your prompt>`.
...
Use `/create-plan` when you want to inspect the plan; skip it if you trust the colleague to just go.
...
Once saved, `/weekly-brief` will be in the picker for that colleague.
