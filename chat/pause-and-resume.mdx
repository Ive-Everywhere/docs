...
When a colleague is busy, the send button in the chat becomes a **Pause** button. Click it to stop the colleague mid-task. Click again later to **Resume** from where it stopped.
...
| Awaiting input (asked you a question) | The chat input is hidden — no pause button shown |
...
<Steps>
  <Step title="Click Pause">
    The send button shows a pause icon when the colleague is busy and the input is empty.
  </Step>
