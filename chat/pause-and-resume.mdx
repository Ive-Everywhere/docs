...
When a colleague is busy, the send button at the bottom of the chat becomes a **Pause** button. Click it to stop the colleague mid-task. Click again later to **Resume** from where it stopped.
...
Slack pause and resume isn't available in the current release. If you start a long session from Slack, use the web app to pause it.
