...
description: A colleague is an Eluu teammate that owns a business function — sales, support, ops — and runs work across Gmail, Slack, Salesforce, and your other tools.
icon: users-round
---
