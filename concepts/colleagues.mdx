...
description: A colleague is an AI teammate that owns a function — sales, support, ops — and runs work across Gmail, Slack, Salesforce, and the rest of your stack.
icon: users-round
---
