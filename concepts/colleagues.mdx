...
description: An AI teammate that owns a business function like sales, support, or ops, and runs work across Gmail, Slack, Salesforce, and the rest of your stack.
icon: users-round
---
