---
title: Colleagues
description: A colleague is an AI teammate that owns a business function and works across the tools you've connected.
icon: users-round
---
...
<CardGroup cols={2}>
  <Card title="The Hard Drive" icon="hard-drive" href="/concepts/hard-disk">
