...
description: An Eluu colleague is a teammate that owns a business function — sales, support, ops — and works across your tools, building memory the longer you use them.
icon: users-round
---
