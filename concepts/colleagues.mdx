...
description: A colleague is a teammate that owns a business function — sales, support, ops, research — and runs work across all the tools your team already uses.
icon: users-round
---
