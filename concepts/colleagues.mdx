...
description: A colleague is an AI teammate in Eluu that owns a business function — sales, support, ops, research — and runs work across every tool you connect.
icon: users-round
---
