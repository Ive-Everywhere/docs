---
title: Jobs
description: Schedule an Eluu colleague to run recurring work — daily morning briefings, hourly customer health checks, weekly reports — without you needing to start it.
icon: calendar-clock
---
