...
description: Recurring colleague work that runs on a schedule — daily digests, hourly health checks, weekly reports — without you in the loop, with full session history.
icon: calendar-clock
---
