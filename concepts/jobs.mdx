...
description: Schedule a colleague to run recurring work — morning briefs, weekly reports, hourly health checks — without you in the loop, with full history of every run.
icon: calendar-clock
---
