...
description: Schedule a colleague to run recurring tasks — morning briefs, hourly health checks, weekly reports — automatically, with each run saved as a full session.
icon: calendar-clock
---
