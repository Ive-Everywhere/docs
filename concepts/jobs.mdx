---
title: Jobs
description: Set up recurring work a colleague in Eluu runs on schedule — daily morning briefings, hourly health checks, weekly reports, automatic monitoring.
icon: calendar-clock
---
