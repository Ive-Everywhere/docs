---
title: Jobs
description: Schedule recurring work for an Eluu colleague — daily morning briefings, hourly pipeline checks, weekly reports — that runs without you and stores history.
icon: calendar-clock
---
