---
title: Jobs
description: Put a colleague on a schedule. Morning sales digests, hourly customer health checks, Friday reports — every run is a real session you can revisit.
icon: calendar-clock
---
