...
description: Schedule a colleague to run recurring work like morning briefs, customer health checks, or weekly reports — every run is a full session you can review.
icon: calendar-clock
---
