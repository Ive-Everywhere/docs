---
title: Jobs
description: Schedule recurring work in Eluu. Jobs let a colleague run morning briefings, hourly health checks, weekly reports, and other tasks on autopilot.
icon: calendar-clock
---
