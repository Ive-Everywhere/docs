...
description: Schedule recurring work — morning briefs, hourly health checks, weekly reports — for an Eluu colleague to run on its own, without you in the loop.
icon: calendar-clock
---
