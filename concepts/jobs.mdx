...
description: Jobs are recurring work an Eluu colleague runs on schedule — daily morning briefings, hourly health checks, weekly reports, and other repeat tasks.
icon: calendar-clock
---
