---
title: Jobs
description: Schedule recurring work in Eluu — morning sales digests, hourly health checks, weekly reports — that a colleague runs on its own with full session history.
icon: calendar-clock
---
