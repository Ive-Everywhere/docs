...
description: Schedule a colleague to run recurring work — morning briefs, hourly health checks, Friday reports — without you in the loop, with full session history.
icon: calendar-clock
---
