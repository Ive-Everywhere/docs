---
title: Jobs
description: Schedule a colleague to run recurring work on its own — daily morning briefings, hourly customer health checks, weekly close-of-week reports, and more.
icon: calendar-clock
---
