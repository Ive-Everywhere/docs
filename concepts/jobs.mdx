---
title: Jobs
description: Recurring work a colleague runs on a schedule — daily morning briefings, hourly health checks, weekly reports — without you having to ask each time.
icon: calendar-clock
---
