---
title: Jobs
description: Schedule recurring work for an Eluu colleague — daily morning briefings, hourly health checks, weekly reports — that runs without you in the loop.
icon: calendar-clock
---
