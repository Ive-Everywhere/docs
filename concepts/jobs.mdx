---
title: Jobs
description: Schedule an Eluu colleague to run recurring work on its own — daily morning briefings, hourly health checks, weekly close-of-business reports, and more.
icon: calendar-clock
---
