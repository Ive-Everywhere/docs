...
description: Schedule a colleague to run recurring work — a morning sales digest, hourly health checks, weekly reports — automatically, without you in the loop.
icon: calendar-clock
---
