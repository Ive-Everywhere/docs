...
description: Put recurring work on autopilot — a colleague runs morning briefs, customer health checks, and weekly digests on the schedule you set, with no babysitting.
icon: calendar-clock
---
