...
description: Schedule recurring sessions like a morning sales digest, hourly customer health check, or Friday wrap-up that a colleague runs without you in the loop.
icon: calendar-clock
---
