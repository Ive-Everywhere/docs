...
description: Invite teammates to your Eluu workspace, assign Owner, Admin, or Member roles, manage pending invitations, and control who can edit colleagues or billing.
icon: user-plus
---
