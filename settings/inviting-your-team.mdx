...
description: Invite teammates to Eluu, assign Owner, Admin, or Member roles, resend pending invites, and remove people so the right people share each colleague.
icon: user-plus
---
