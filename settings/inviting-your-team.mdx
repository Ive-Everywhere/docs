...
description: Invite teammates to your Eluu team and assign Member, Admin, or Owner roles to control who can build colleagues, manage integrations, and bill.
icon: user-plus
---
