...
Same People page. Click into someone's row, then **Remove from team**. They lose access immediately. Anything they created — colleagues marked Personal — stays where it is, but the team can no longer access them.
