...
description: Invite teammates to Eluu by email, pick Owner, Admin, or Member roles, resend or cancel pending invites, and remove people without losing shared work.
icon: user-plus
---
