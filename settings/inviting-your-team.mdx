...
description: Bring teammates into your Eluu team. Send invites, pick roles like Owner, Admin, or Member, and control who can build colleagues or manage billing.
icon: user-plus
---
