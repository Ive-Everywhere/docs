...
description: Invite teammates into your Eluu workspace, pick their role — Owner, Admin, or Member — and share the colleagues, integrations, and views you've built.
icon: user-plus
---
