...
description: Invite teammates to your Eluu workspace, pick their role — Owner, Admin, or Member — and share colleagues so the whole team benefits from the same workflows.
icon: user-plus
---
