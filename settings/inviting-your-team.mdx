...
description: Invite teammates to your Eluu team, pick the right role between Member, Admin, and Owner, and resend or cancel invitations that haven't been accepted yet.
icon: user-plus
---
