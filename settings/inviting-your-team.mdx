...
description: Invite teammates into your Eluu workspace, pick a role for each person, and share the colleagues you've built so the whole team gets the value.
icon: user-plus
---
