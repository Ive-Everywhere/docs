---
title: API keys
description: Bring your own Anthropic, OpenAI, Gemini, or other LLM provider keys to Eluu to control cost, pick a model, or stay within your vendor relationships.
icon: key
---
