---
title: API keys
description: Bring your own Anthropic, OpenAI, Gemini, or other LLM provider keys to control cost or pick a specific model. Optional — every plan includes credits.
icon: key
---
