---
title: API keys
description: Bring your own LLM provider API keys for OpenAI, Anthropic, or others to control costs and pick the model. Optional — every Eluu plan includes credits.
icon: key
---
