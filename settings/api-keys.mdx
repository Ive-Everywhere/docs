---
title: API keys
description: Bring your own LLM provider keys for OpenAI, Anthropic, or others to control cost and pick the model. Optional — Eluu includes credits on every plan.
icon: key
---
