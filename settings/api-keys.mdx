---
title: API keys
description: Bring your own LLM provider keys to Eluu to control cost or pick a specific model — Anthropic, OpenAI, Gemini, and others. Optional on every plan.
icon: key
---
