---
title: API keys
description: Bring your own LLM provider keys to Eluu to control cost or pick a specific model. Optional — every Eluu plan ships with credits included by default.
icon: key
---
