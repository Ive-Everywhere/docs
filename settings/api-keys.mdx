---
title: API keys
description: Bring your own OpenAI, Anthropic, or other LLM provider keys to Eluu to control cost or pick a specific model. Optional — every plan includes credits.
icon: key
---
