...
description: Bring your own LLM keys for cost control, model choice, or compliance.
icon: key
---
...
Eluu encrypts every key at rest. You can't view a key after you save it — if you need to update one, paste the new one and save again.
