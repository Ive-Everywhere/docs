...
Eluu encrypts every key at rest. You can't view a key after you save it — if you need to update one, paste the new one and save again. There's no way to view the old one back.
