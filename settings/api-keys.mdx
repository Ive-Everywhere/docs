...
Every key is encrypted before we store it. They're never visible after you save — if you need to update one, paste the new one and save again. There's no way to view the old one back.
