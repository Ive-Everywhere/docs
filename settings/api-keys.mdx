---
title: API keys — bring your own LLM provider keys
description: Bring your own Anthropic, OpenAI, Gemini, or other LLM provider keys to control cost, pick a model, or meet compliance — optional on every Eluu plan.
icon: key
---
...
## Setting per-teammate budgets

If multiple people on your team use the same key, you can set a soft monthly budget per teammate. When someone goes over, their requests slow down (rather than fail) and you get an alert. Useful for keeping any one teammate from running away with the budget.
