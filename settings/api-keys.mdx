---
title: API keys
description: Bring your own LLM provider keys for OpenAI, Anthropic, or Google to control cost or pick a specific model. Optional — every Eluu plan includes credits.
icon: key
---
