---
title: API keys
description: Bring your own keys for Anthropic, OpenAI, Gemini, and other LLM providers to control cost or pick a specific model. Optional — every plan includes credits.
icon: key
---
