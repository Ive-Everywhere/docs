...
To add another account, click **Manage** on the tool card to open the integration's settings. Find the accounts section and click **Add another store** (or whatever the integration calls it).
