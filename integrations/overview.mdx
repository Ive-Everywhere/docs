---
title: Connecting tools — wire integrations to Eluu
description: Connect Gmail, Slack, Google Sheets, Salesforce, HubSpot, Notion, GitHub, and more so your colleagues can read, write, and act across your stack.
icon: plug
---
