...
To add another account, open the integration's manage drawer — click **Manage** on the tool card. Find the accounts section, then click **Add another store** (or whatever the integration calls it).
