...
OAuth tokens occasionally expire or get revoked. When that happens, the tool shows a `Needs reauth` chip. Click into it and re-run the OAuth flow. Anything waiting on the tool resumes as soon as you reconnect it.
