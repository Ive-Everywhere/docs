...
description: Connect Gmail, Slack, Salesforce, HubSpot, Notion, Sheets, GitHub, and other tools to Eluu so colleagues can read, write, and act across your stack.
icon: plug
---
