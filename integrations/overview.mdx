...
<Steps>
  ...
  <Step title="Click Connect">
    Eluu opens the tool's sign-in. You sign in to the provider, review the permissions, and approve.
  </Step>
...
Sign-ins occasionally expire or get revoked. When that happens, the tool shows a `Needs reauth` label. Click into it and sign in again. Anything that was waiting on the tool resumes once it's reconnected.
