...
To add another account, open the integration's settings (click **Manage** on the tool card), find the accounts section, and click **Add another store** (or whatever the integration calls it).
...
To disconnect entirely, open the integration's settings and click **Disconnect**. Any colleague using the tool will lose access immediately.
