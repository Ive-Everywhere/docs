...
description: Connect tools like Gmail, Slack, Sheets, and Salesforce to Eluu.
icon: plug
---
...
<Steps>
  ...
  <Step title="Pick the scope">
    Personal (just you) or Shared (your whole team). Personal is the default. See [Personal vs Shared](/integrations/team-vs-personal) for which to pick.
  </Step>
